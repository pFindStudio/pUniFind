...
if __name__ == "__main__":
    ...
    parser.add_argument('pUniFind_spectra_path', help='Input path to the pUniFind .spectra result file')
    args = parser.parse_args()

    # Optional: Check if files or paths exist
    if not os.path.exists(args.pFind_path):
        parser.error("The specified pFind project path does not exist: " + args.pFind_path)
    if not os.path.exists(args.pUniFind_spectra_path):
        parser.error("The specified pUniFind .spectra file does not exist: " + args.pUniFind_spectra_path)
