...
<!-- [![Nature Machine Intelligence](https://img.shields.io/badge/arXiv-2308.12345-B31B1B)]([https://arxiv.org/abs/1234.56789](https://arxiv.org/abs/2507.00087](https://www.nature.com/articles/s42256-026-01234-8))
...
## &#x1F4E3; News
- **2026/2/28** Memory protection to prevent leaks; optimized preprocessing for speed; added unit test with demo data; refined default parameters; updated license; bug fixes.
- **2026/2/1** pUniFind has released a more user-friendly version of its Linux source code! Please refer to the updated 'Linux Usage Instructions' in the User Guide for more details. We are also working on a fix for Windows-specific issues—stay tuned.
